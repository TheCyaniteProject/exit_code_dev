...
def main(main_frame, check_profiles):
    ...
    def create_profile():
        ...
        try:
            ...
            elif pronouns.get() == 'She/Her':
                profile['pronouns'] = 'female'
            elif pronouns.get() == 'He/Him':
                profile['pronouns'] = 'male'
            elif pronouns.get() == '"RainbowDashies\' Pyromancing Floof-ball"':
                profile['pronouns'] = 'floofball'
            # Non-Trolling stuffs~
